...
write.csv(importance_vals,"~/Chinook_growth_repo/model_output/clusters/RF_importnace_values_n4.csv")
...
####run for k=3
data_clusters_k3 <- read.csv("~/Chinook_growth_repo/model_output/clusters/data_n3with_outliers_age4_seed4.csv")
stock_characteristics <- read.csv("~/Chinook_growth_repo/transformed_data/stock_characteristics_data.csv")
...
write.csv(importance_vals,"~/Chinook_growth_repo/model_output/clusters/RF_importnace_values_with_outliers_n3.csv")
...
#### re run for k=5
data_clusters_k5 <- read.csv("~/Chinook_growth_repo/model_output/clusters/data_n5_age4_seed4.csv")

dat <- data_clusters_k5 %>% 
  dplyr::group_by(stock_char) %>%
  dplyr::summarize(
    cluster = mean(cluster))%>%
  dplyr::mutate(stock = stock_char)%>%
