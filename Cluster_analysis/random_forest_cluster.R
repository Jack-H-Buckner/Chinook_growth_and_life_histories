...
####run for k=4
data_clusters <- read.csv("model_output/cluster_data/data_n4_age4_seed3.csv")
likelihoods <- read.csv("model_output/cluster_data/likelihoods_n4_age4_seed3.csv")
group_labs <- read.csv("transformed_data/increment_model_group_labels.csv")
...
write.csv(importance_vals,"model_output/cluster_data/RF_importnace_values_n4.csv")
...
write.csv(importance_vals,"model_output/cluster_data/RF_importnace_values_n3.csv")
...
#### re run for k=5
data_clusters <- read.csv("model_output/cluster_data/data_n5_age4_seed1.csv")
likelihoods <- read.csv("model_output/cluster_data/likelihoods_n5_age4_seed1.csv")
group_labs <- read.csv("transformed_data/increment_model_group_labels.csv")
stock_characteristics <- read.csv("transformed_data/stock_characteristics_data_more_regions.csv")
...
write.csv(importance_vals,"model_output/cluster_data/RF_importnace_values_n5.csv")
