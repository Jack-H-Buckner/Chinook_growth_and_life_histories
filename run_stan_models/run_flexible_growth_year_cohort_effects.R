...
stan_file <- "~/Chinook_growth_repo/stan_models/flexible_growth_year_cohort_effects.stan"
...
run_analysis <- function(stock_group){
  ...
  fit = stan(stan_file,
             ...
             chains =1,
             iter = 1000,
             control=list(max_treedepth = 10, adapt_delta=0.70),
  ...
  write.csv(samples, paste("~/Chinook_growth_repo/model_output/HMC_samples/samples_flexible_YC_", stock_group, "_2.csv", sep = ""))
  write.csv(data, paste("~/Chinook_growth_repo/model_output/HMC_samples/data_flexible_YC_", stock_group, "_@.csv", sep = ""))
  write.csv(samples[sample(1:4000,500),], paste("~/Chinook_growth_repo/model_output/HMC_samples/short_samples_flexible_YC_", stock_group, "_@.csv", sep = ""))
  write.csv(samples,"~/Chinook_growth_repo/model_output/HMC_samples/priors_flexible_YC_1.csv")
